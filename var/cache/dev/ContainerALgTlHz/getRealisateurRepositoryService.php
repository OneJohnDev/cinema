 ...
 */
class getRealisateurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RealisateurRepository' shared autowired service.
     *
     * @return \App\Repository\RealisateurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RealisateurRepository.php';

        return $container->privates['App\\Repository\\RealisateurRepository'] = new \App\Repository\RealisateurRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
